...
\section{Ausgewählte Erkrankungen}
    ...
    \begin{itemize}
        \item Kann in jedem Körperteil bei Viren-/Bakterien- oder Parasitenbefall auftreten
    ...
    \begin{itemize}
        ...
        \item Verursacht möglicherweise Zahnschmerzen, Fressprobleme, Herzerkrankungen
    \end{itemize}
